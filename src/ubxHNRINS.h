/*
  ...
  v4 scaffolding: UBX-HNR-INS - implemented as its own Class, per AGENTS.md
  "Implement each UBX message in its own Class". Auto-generated field table from u-blox_structs.h's
  UBX_HNR_INS_data_t (verified against the byte offsets used by the existing v3 extract*() calls in
