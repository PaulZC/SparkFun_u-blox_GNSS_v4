...
public:
    ...
    /**
     * @brief Construct a new ubxTIMTM2 object and register it with the UBX message registry.
     *
     * UBX-TIM-TM2: Time mark data. Registers this message's Class/ID, field table, callback-copy count and
