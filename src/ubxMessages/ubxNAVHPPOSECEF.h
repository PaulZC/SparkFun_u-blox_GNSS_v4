 ...
 *
 * 
 * @file ubxNAVHPPOSECEF.h
 *
 * v4 scaffolding: UBX-NAV-HPPOSECEF - implemented as its own Class.
 */
...
public:
    ...
    /**
     * @brief Construct a new ubxNAVHPPOSECEF object and register it with the UBX message registry.
     *
     * UBX-NAV-HPPOSECEF: High precision position solution in ECEF. Registers this message's Class/ID, field table, callback-copy count and
