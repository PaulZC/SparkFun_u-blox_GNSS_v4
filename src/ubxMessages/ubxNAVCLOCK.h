/*
  ...
  v4 scaffolding: UBX-NAV-CLOCK - implemented as its own Class, per AGENTS.md
  "Implement each UBX message in its own Class". Auto-generated field table from u-blox_structs.h's
  UBX_NAV_CLOCK_data_t (verified against the byte offsets used by the existing v3 extract*() calls in
