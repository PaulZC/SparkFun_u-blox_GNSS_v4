...
public:
    ...
    /**
     * @brief Construct a new ubxESFRAW object and register it with the UBX message registry.
     *
     * UBX-ESF-RAW: Raw sensor measurements. Registers this message's Class/ID, field table, callback-copy count and
